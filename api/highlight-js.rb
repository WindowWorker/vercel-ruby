...
for(let i=0;i<prs_length;i++){try{
  prs[i].innerHTML='<code class="language-ruby">#highlight#\\n'+prs[i].innerHTML+'</code>';
...
for(let i=0;i<notprs_length;i++){try{
  ...
  notprs[i].outerHTML='<pre class="language-ruby">#highlight#\\n'+notprs[i].outerHTML+'</pre>';
}catch(e){await console.log(e); continue;}}
...
for(let i=0;i<aprs_length;i++){try{
  aprs[i].innerHTML='<code class="language-ruby">#highlight#\\n'+aprs[i].innerHTML+'</code>';
}catch(e){await console.log(e); continue;}}
